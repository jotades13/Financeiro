...
public class LancamentoFinanceiroService {
   ...
   private EntityManager manager;
    ...
    public List<LancamentoFinanceiro> listaLancamentos(String _ano, String _mes, Long _grupo,String _descricao){
        ...
        if(_grupo>0){
          predicates.add(builder.equal(root.get("grupoFinanceiro").get("codigo"),_grupo));
        } 
