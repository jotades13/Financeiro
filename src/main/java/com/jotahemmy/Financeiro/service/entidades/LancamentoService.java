...
public class LancamentoService {
  ...
  public List<LancamentoDto> listaLancamentos(Integer _ccusto, Contas _contas, Status _status, Integer _ano, Integer _mes, Integer _lancadosdias, String _descricao, Boolean _dspFixa, Integer _grupo){
    ...
    if(_grupo>0){
      predicates.add(builder.equal(root.get("grupo").get("codigo"),_grupo));
    }
